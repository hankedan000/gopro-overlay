...
namespace gpo
{
    ...
    static const char * CMD_NAME = "top-bottom-overlay";
    ...
    TopBottomOverlayCmd::TopBottomOverlayCmd()
     : Command(CMD_NAME)
    {
